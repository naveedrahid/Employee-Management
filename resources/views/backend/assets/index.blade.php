    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card position-relative">
            ...
            <div class="d-flex align-items-center justify-content-between">
                <h5 class="card-header">{{ __('Manage Asset') }}</h5>
                <div class="card-header">
                    <a href="{{ route('backend.asset.create') }}" class="btn btn-secondary">{{ __('Add Asset') }}</a>
                </div>
            </div>
            <div class="table-responsive text-nowrap">
                <table class="table table-striped">
                    ...
                    <tbody class="table-border-bottom-0">
                        @forelse ($assets as $asset)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <hr class="m-0">
                                    <p class="m-0"><small><strong>{{ __('Asset Code') }}</strong>:
                        ...
                        @empty
                            <tr>
                                <td class="text-center" colspan="9">{{ __('No Asset Found') }}</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
